...
<div class="cont">
  ...
  <script>
    var swiper2 = new Swiper(".mySwiper", {
      ...
      <div class="wrapper">
        ...
        <div class="profile">
         <div class="silde-img">
             <a href="book.html?Amount=<%=500%>"><img src="images/images/spb charan.jpg"></a>
 ...
 <div class="profile">
   <div class="silde-img">
       <a href="book.html?Amount=<%=399%>"><img src="images/images/supermayan.jpg"></a>
       <h5 class="time">Sat,17 jun</h5>
   </div>
     <div class="details">
   <h4>SuperMayan</h4><BR>
 ...
 <div class="profile">
  <div class="silde-img">
     <a href="book.html?Amount=<%=1000%>"> <img src="images/images/pradeep.jpg"></a>
...
<div class="profile">
  <div class="silde-img">
      <a href="book.html?Amount=<%=3750%>"><img src="images/images/sunburn.jpg"></a>
